...
// Pins + codec address match Waveshare's factory 07_ES8311 example for this
// board. The ES8311 shares the I2C bus above; the power amp is enabled through
// GPIO 46 immediately before playback.
