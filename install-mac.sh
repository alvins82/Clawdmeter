...
echo "  ./switch-provider.sh both              # show Claude + Codex usage"
echo "  ./switch-provider.sh claude            # show only Claude Code usage"
echo "  ./switch-provider.sh codex             # show only Codex usage"
